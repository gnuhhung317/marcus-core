...
public class ListCurrentUserLoginActivitiesUseCase {
    ...
    public UserProfileReadPort.LoginActivityPageSnapshot execute(int page, int size) {
        ...
        return userProfileReadPort.listCurrentUserLoginActivities(userId, normalizedPage, normalizedSize);
    }
}
